...
import { HOTEL, hotelJsonLd } from "@/lib/hotel";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GuruChhaya Hotel and Cottages | Mountain-View Hotel in Manali" },
      {
        name: "description",
        content:
          "GuruChhaya Hotel and Cottages — boutique mountain-view hotel on Hadimba Temple Road, Manali. Private balconies, free Wi-Fi & parking, restaurant. Book on WhatsApp.",
      },
      { name: "author", content: HOTEL.name },
      { property: "og:site_name", content: HOTEL.name },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "en_IN" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#5a3d2b" },
      { name: "geo.region", content: "IN-HP" },
      { name: "geo.placename", content: "Manali" },
    ],
    links: [
